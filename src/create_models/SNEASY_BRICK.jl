...
Function Arguments:
        ...
        glacier_model   = glaciers & small ice caps model; `:mengel` (default) = the
                          temperature-dependent-equilibrium Mengel-2016 emulator,
                          `:gsic` = the original single-reservoir Wigley-Raper-Bakker
                          component (same glaciers + small-ice-cap inventory)
"""
